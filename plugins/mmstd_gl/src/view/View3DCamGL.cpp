...
/*
 * View3DCamGL::View3DCamGL
 */
View3DCamGL::View3DCamGL() : BaseView(ViewDimension::VIEW_3D) {
...
megamol::frontend_resources::ImageWrapper View3DCamGL::Render(double time, double instanceTime) {
...
megamol::frontend_resources::ImageWrapper View3DCamGL::GetRenderingResult() const {
...
void View3DCamGL::Resize(unsigned int width, unsigned int height) {
    ...
    if (create_fbo) {
        ...
        try {
            ...
            megamol::core::utility::log::Log::DefaultLog.WriteError(
                "[View3DCamGL] Unable to create framebuffer object: %s\n", exc.what());
        }
    }
}
